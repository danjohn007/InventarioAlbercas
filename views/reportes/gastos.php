...
function exportarPDF() {
    ...
    window.location.href = '<?php echo BASE_URL; ?>reportes/gastos/pdf?' + params.toString();
}

function exportarExcel() {
    const params = new URLSearchParams(window.location.search);
    window.location.href = '<?php echo BASE_URL; ?>reportes/gastos/excel?' + params.toString();
}
</script>

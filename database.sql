...
('Supervisor', 'Gestión de inventario, gastos y servicios', '{"usuarios": ["leer"], "inventario": ["crear", "leer", "actualizar"], "gastos": ["crear", "leer", "actualizar"], "servicios": ["crear", "leer", "actualizar"], "clientes": ["crear", "leer", "actualizar"], "reportes": ["leer", "exportar"], "ingresos": ["crear", "leer", "actualizar"]}'),
